...
public class TBCCustomizeOriginalBean  
{
	...
	private Double txFundLockAmount;                 //资金交易金额:100000￥,锁定金额
	private Double txFundAmount;                        //资金交易金额:100000￥,可用金额
	...
	HashMap<String,String> nonquantifiableInfo; //原始交易中需要保持的非量化信息，比如地址的更新，手机号的更新等 //eg.  address:beijing       phonenumber:132696888888 
	...
	public Double getTxFundLockAmount() {
		return txFundLockAmount;
	}
	public void setTxFundLockAmount(Double txFundLockAmount) {
		this.txFundLockAmount = txFundLockAmount;
	}
	public Double getTxFundAmount() {
		return txFundAmount;
	}
	public void setTxFundAmount(Double txFundAmount) {
